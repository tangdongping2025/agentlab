...
const DEFAULT_SCENES: SceneConfig[] = [
  {
    ...
    name: '投资助手',
    icon: '📈',
    systemPrompt: '你是一个专业的投资助手，帮助用户搜索和分析股票、市场、财经新闻等信息。重要规则：涉及实时信息（当前日期、新闻、行情、最新数据等）时，必须使用搜索工具获取，不要凭记忆回答，你的训练数据可能已过时。',
    tools: ['anysearch'],
    isPreset: true,
  },
  {
    ...
    name: '研究分析',
    icon: '🔬',
    systemPrompt: '你是一个研究分析助手，帮助用户搜索信息、查询资料、提取网页内容。重要规则：涉及实时信息（当前日期、新闻、最新数据等）时，必须使用搜索工具获取，不要凭记忆回答，你的训练数据可能已过时。',
